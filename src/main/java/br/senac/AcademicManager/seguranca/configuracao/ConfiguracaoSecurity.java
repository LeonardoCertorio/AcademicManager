package br.senac.AcademicManager.seguranca.configuracao;

import br.senac.AcademicManager.seguranca.dominio.Papel;
import br.senac.AcademicManager.seguranca.dominio.jwt.AuthEntryPointJwt;
import br.senac.AcademicManager.seguranca.dominio.jwt.AuthTokenFilter;
import br.senac.AcademicManager.seguranca.dominio.jwt.JwtUtils;
import br.senac.AcademicManager.seguranca.dominio.DefaultUserDetailsService;
    ...
    public SecurityFilterChain myFilterChain(HttpSecurity http,
        ...
        http
                .authorizeHttpRequests((authz) -> authz
                        ...
                        .requestMatchers(antMatcher("/restrito/**")).hasAnyRole(Papel.ADMIN.name(), Papel.GERENTE.name())
                        .requestMatchers(antMatcher("/admin/**")).hasRole(Papel.ADMIN.name())
