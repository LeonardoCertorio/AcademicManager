package br.senac.AcademicManager.alunos.api;

import br.senac.AcademicManager.alunos.dominio.Aluno;
import br.senac.AcademicManager.alunos.dominio.AlunoRepositorio;
    ...
    public ResponseEntity<Aluno> update(@PathVariable("id") long id,
        ...
        return alunoRepositorio.findById(id)
                .map(record -> {
                    ...
                    record.setDepartamento(aluno.getDepartamento());
